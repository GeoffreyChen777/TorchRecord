...
_DEVICEOPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hip_gpu_id', full_name='caffe2.DeviceOption.hip_gpu_id', index=6,
